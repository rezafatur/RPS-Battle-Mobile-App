                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () {
                          controller.isReadyPlayer2.value = true;
                          Navigator.of(context).pop();
                        },
                        style: ElevatedButton.styleFrom(
                          elevation: 0,
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        // Section - Player 2 and Main
        Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            // Section - Profile, and Player 2 turn
            Padding(
              padding: const EdgeInsets.symmetric(
                horizontal: 40,
                vertical: 20,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            controller.setPlayer2Choice(Choice.rock);
                          },
                          style: ElevatedButton.styleFrom(
                            shape: RoundedRectangleBorder(
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            controller.setPlayer2Choice(Choice.paper);
                          },
                          style: ElevatedButton.styleFrom(
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(50),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            controller.setPlayer2Choice(Choice.scissors);
                          },
                          style: ElevatedButton.styleFrom(
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(50),
